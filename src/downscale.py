...
Processing:
    ...
    6. Save the processed data as a pickle file in the write_folder.
    7. Copy the SimulationData.txt file from the read_folder to the write_folder.
    8. Modify the 'Number of cells (x)' and 'Number of cells (y)' lines in the SimulationData.txt file.
