...
#SBATCH --job-name=job1-1-8-     # create a short name for your job
#SBATCH --nodes=1               # node count 
#SBATCH --gres=gpu:1             # number of allocated gpus per node ### Note: --gres=gpu:x should equal to ntasks-per-node
...
srun python -m "$REPO_DIR"src.trainers --work_dir "$OUTPUT_DIR" --force --run "1-1-8"
